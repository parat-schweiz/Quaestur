...
namespace Petitio
{
    public class NamedIdViewModel
    {
        ...
        public NamedIdViewModel(Translator translator, Queue queue, bool selected)
        {
        ...
        public NamedIdViewModel(Translator translator, Subscription subscription, bool selected)
        {
            ...
            Name = subscription.Queue.Value.Name.Value[translator.Language].EscapeHtml();
            Selected = selected;
        }
        ...
        public NamedIdViewModel(Translator translator, Group group, bool selected)
        {
            ...
            Name = group.Queue.Value.Name.Value[translator.Language].EscapeHtml() + " / " +
        ...
        {
            Id = role.Id.ToString();
            Name = role.Group.Value.Queue.Value.Name.Value[translator.Language].EscapeHtml() + " / " +
