...
namespace Petitio
{
    ...
    public class RoleListItemViewModel
    {
        ...
        public RoleListItemViewModel(Translator translator, IDatabase database, Session session, Role role)
        {
            ...
            Editable =
                session.HasAccess(role.Group.Value.Queue.Value, PartAccess.Structure, AccessRight.Write) ?
    ...
    public class RoleListViewModel
    {
        ...
        public string PhraseHeaderQueueGroup;
        ...
        {
            PhraseHeaderQueueGroup = 
                translator.Get("Role.List.Header.QueueGroup", "Header with queue and group in the role list", "{0} of {1}",
                group.Name.Value[translator.Language],
                group.Queue.Value.Name.Value[translator.Language]).EscapeHtml();
            ...
            Id = group.Id.Value.ToString();
            ParentId = group.Queue.Value.Id.Value.ToString();
    ...
    public class RoleEdit : PetitioModule
    {
        public RoleEdit()
        {
