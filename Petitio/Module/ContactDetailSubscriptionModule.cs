...
namespace Petitio
{
    ...
    public class ContactDetailSubscriptionViewModel
    {
        ...
        public ContactDetailSubscriptionViewModel(IDatabase database, Translator translator, Session session, Contact contact)
        {
            ...
            PhraseHeaderQueue = translator.Get("Contact.Detail.Subscription.Header.Queue", "Column 'Queue' on the subscription tab of the contact detail page", "Queue");
    ...
    public class ContactDetailSubscriptionModule : PetitioModule
    {
