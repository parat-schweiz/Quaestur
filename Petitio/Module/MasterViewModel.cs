...
namespace Petitio
{
    ...
    public class MasterViewModel
    {
        ...
        public string PhraseMenuQueues = string.Empty;
        ...
        public MasterViewModel(Translator translator, string title, Session session)
        {
            ...
            NavExport = session != null && session.HasAnyQueueAccess(PartAccess.Contact, AccessRight.Read);
            NavMailing = session != null && session.HasAnyQueueAccess(PartAccess.Contact, AccessRight.Write);
            NavQueue = session != null && session.HasAnyQueueAccess(PartAccess.Structure, AccessRight.Read);
            NavSettings = session != null && session.HasAnyQueueAccess(PartAccess.Crypto, AccessRight.Read);
            ...
            PhraseMenuQueues = translator.Get("Master.Menu.Custom.Queues", "Item 'Queues' in the main menu", "Queues").EscapeHtml();
