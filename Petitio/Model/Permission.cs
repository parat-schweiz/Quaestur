        ...
        public static string Translate(this SubjectAccess member, Translator translator)
        {
            switch (member)
            {
                ...
                case SubjectAccess.Queue:
                    return translator.Get("Enum.SubjectAccess.Queue", "Value 'Queue' in MemberAccess enum", "Queue");
                case SubjectAccess.SubQueue:
                    return translator.Get("Enum.SubjectAccess.SubQueue", "Value 'SubQueue' in MemberAccess enum", "Queue and below");
