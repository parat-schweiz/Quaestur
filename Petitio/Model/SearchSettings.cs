...
namespace Petitio
{
    ...
    public class SearchSettings : DatabaseObject
    {
        ...
        public ForeignKeyField<Queue, SearchSettings> FilterSubscription { get; private set; }
        ...
        public SearchSettings(Guid id) : base(id)
        {
            ...
            FilterSubscription = new ForeignKeyField<Queue, SearchSettings>(this, "filtersubscription", true, null);
