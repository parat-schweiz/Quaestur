...
namespace Census
{
    public class PermissionEditViewModel : DialogViewModel
    {
            ...
            : this(translator)
        {
            ...
            Right = string.Empty;
            Parts.Add(new NamedIntViewModel(translator, PartAccess.Questionaire, false));
            ...
            : this(translator)
        {
            ...
            Parts.Add(new NamedIntViewModel(translator, PartAccess.Questionaire, permission.Part.Value == PartAccess.Questionaire));
    ...
    public class PermissionEdit : CensusModule
    {
