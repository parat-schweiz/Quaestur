...
namespace Hospes
{
    ...
    public class MailTemplateListItemViewModel
    {
        ...
        public MailTemplateListItemViewModel(IDatabase database, Session session, Translator translator, MailTemplate mailTemplate)
        {
            ...
            Editable = session.HasAccess(mailTemplate.Organization.Value, mailTemplate.AssignmentType.Value.AccessPart(), AccessRight.Write) ? "editable" : string.Empty;
            ...
            Get("/mailtemplate/copy/{id}", parameters =>
            {
                ...
                if (mailTemplate != null)
                {
                                  ...
                                  AccessRight.Write))
                    {
                        ...
                        newTemplate.Organization.Value = mailTemplate.Organization.Value;
