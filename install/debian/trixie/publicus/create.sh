...
cp -a ../../../../Publicus/bin/Release/*.dll "$PROGDIR/"
cp -a ../../../../Publicus/bin/Release/*.exe "$PROGDIR/"
cp -ar ../../../../Publicus/bin/Release/View "$PROGDIR/"
cp -ar ../../../../Publicus/bin/Release/Assets "$PROGDIR/"
