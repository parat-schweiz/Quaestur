...
cp -a ../../../../SecurityServiceClient/bin/Release/*.dll "$PROGDIR/"
cp -a ../../../../Quaestur/bin/Release/*.dll "$PROGDIR/"
cp -a ../../../../Quaestur/bin/Release/*.exe "$PROGDIR/"
cp -ar ../../../../Quaestur/bin/Release/View "$PROGDIR/"
cp -ar ../../../../Quaestur/bin/Release/Assets "$PROGDIR/"
