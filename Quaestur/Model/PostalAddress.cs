...
namespace Quaestur
{
    ...
    {
        public ForeignKeyField<Person, PostalAddress> Person { get; set; }
        ...
        {
            Person = new ForeignKeyField<Person, PostalAddress>(this, "personid", false, p => p.PostalAddresses);
        ...
        {
            Person.Value.PostalAddresses.Remove(this);
