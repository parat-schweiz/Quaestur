...
namespace Quaestur
{
    ...
    public class Mailing : DatabaseObject
    {
        ...
        public ForeignKeyField<Organization, Mailing> RecipientOrganization { get; set; }
        ...
        public ForeignKeyField<Person, Mailing> Creator { get; set; }
        ...
        public DateTimeField CreatedDate { get; set; }
        public DateTimeNullField SendingDate { get; set; }
        public DateTimeNullField SentDate { get; set; }
        ...
        public Mailing(Guid id) : base(id)
        {
            ...
            RecipientOrganization = new ForeignKeyField<Organization, Mailing>(this, "recipientorganizationid", false, null);
            ...
            Creator = new ForeignKeyField<Person, Mailing>(this, "creatorid", false, null);
            ...
            CreatedDate = new DateTimeField(this, "createddate", DateTime.UtcNow);
            SendingDate = new DateTimeNullField(this, "sendingdate");
            SentDate = new DateTimeNullField(this, "sentdate");
