...
namespace Quaestur
{
    public class PointsTallyTask : ITask
    {
        ...
        private void RunAll(IDatabase database)
        {
                ...
                .Where(p => !p.Deleted.Value))
            {
                ...
                if (membership != null)
                {
                    ...
                    {
                        if (CreatePointsTally(database, translation, membership))
                        {
                            _maxMailsCount--;
                        }
                    }
        ...
        private bool CreatePointsTally(IDatabase database, Translation translation, Membership membership)
        {
        ...
        public static MimeMessage CreateMail(IDatabase database, Membership membership, MailTemplate mailTemplate)
        {
