        ...
        public MailingElementEdit()
        {
                ...
                if (status.ObjectNotNull(mailingElement))
                {
                    if (status.HasAccess(mailingElement.Owner.Value, PartAccess.Mailings, AccessRight.Write))
                    {
                        ...
                        if (status.IsSuccess)
                        {
                            ...
                            Notice("{0} changed mailing element {1}", CurrentSession.User.ShortHand, mailingElement);
                        }
                    }
                }
            ...
            Post("/mailingelement/add/new", parameters =>
            {
                ...
                if (status.HasAccess(mailingElement.Owner.Value, PartAccess.Mailings, AccessRight.Write))
                {
                    ...
                    {
                        Database.Save(mailingElement);
                        Notice("{0} added mailing element {1}", CurrentSession.User.ShortHand, mailingElement);
                    }
                }
            ...
            Get("/mailingelement/delete/{id}", parameters =>
            {
                ...
                if (status.ObjectNotNull(mailingElement))
                {
                    if (status.HasAccess(mailingElement.Owner.Value, PartAccess.Mailings, AccessRight.Write))
                    {
                        ...
                        Notice("{0} deleted mailing element {1}", CurrentSession.User.ShortHand, mailingElement);
                    }
                }
                return status.CreateJsonData();
            });
