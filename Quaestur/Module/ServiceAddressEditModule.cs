...
namespace Quaestur
{
    public class ServiceAddressEditViewModel : DialogViewModel
    {
        ...
        public ServiceAddressEditViewModel(Translator translator, IDatabase db, Person person, ServiceType service)
            : this(translator, service)
        {
            ...
            Categories.Add(new NamedIntViewModel(translator, AddressCategory.Organization, false));
        }
            ...
            : this(translator, address.Service.Value)
        {
            ...
            Categories.Add(new NamedIntViewModel(translator, AddressCategory.Organization, address.Category.Value == AddressCategory.Organization));
        }
    }
    ...
    public class ServiceAddressEdit : QuaesturModule
    {
        public ServiceAddressEdit()
        {
            ...
            Get("/serviceaddress/edit/{id}", parameters =>
            {
                ...
                if (address != null)
                {
                    if (HasAccess(address.Person.Value, PartAccess.Contact, AccessRight.Write))
                    {
            ...
            Get("/serviceaddress/add/phone/{id}", parameters =>
            {
                ...
                if (person != null)
                {
                    ...
                    {
                        return View["View/serviceaddressedit.sshtml",
                            new ServiceAddressEditViewModel(Translator, Database, person, ServiceType.Phone)];
                    }
                }
            ...
            Get("/serviceaddress/add/mail/{id}", parameters =>
            {
                ...
                if (person != null)
                {
                    ...
                    {
                        return View["View/serviceaddressedit.sshtml",
                            new ServiceAddressEditViewModel(Translator, Database, person, ServiceType.EMail)];
                    }
                }
            ...
            Post("/serviceaddress/add/{id}", parameters =>
            {
                ...
                if (status.ObjectNotNull(person))
                {
                    ...
                    address.Precedence.Value = person.PostalAddresses.MaxOrDefault(a => a.Precedence.Value, 0) + 1;
            ...
            Post("/serviceaddress/switch", parameters =>
            {
                ...
                {
                    if (status.HasAccess(source.Person.Value, PartAccess.Contact, AccessRight.Write))
                    {
                        var target = source.Person.Value.ServiceAddresses
                        ...
                        if (status.ObjectNotNull(target))
                        {
                            ...
                            Database.Save(source.Person);
                            switch (source.Service.Value)
                            {
                                case ServiceType.EMail:
                                    Journal(source.Person, 
