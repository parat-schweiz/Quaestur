...
namespace Quaestur
{
        ...
        where TObject : DatabaseObject, new()
    {
        ...
        public DateWidget(Form<TObject> form, string id, int width, string phraseField, Func<TObject, DateField> field, DateTime? defaultValue, DateTime startDate, DateTime endDate, Language language)
