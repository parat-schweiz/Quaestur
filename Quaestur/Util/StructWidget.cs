...
namespace Quaestur
{
    public abstract class StructWidget<TObject, TField, TValue> : Widget<TObject>
        ...
        where TValue : struct
    {
        ...
        public StructWidget(Form form, string id, int width, bool required, string phraseField)
